...
class ResourcesDatasourceImpl:ResourcesDatasource {
    ...
    private val foodReferenceMap = mapOf(
        0 to R.string.question_10_answer_1,
        1 to R.string.question_10_answer_2,
        2 to R.string.question_10_answer_3,
        3 to R.string.question_10_answer_4,
        4 to R.string.question_10_answer_5,
        5 to R.string.question_10_answer_6,
        6 to R.string.question_10_answer_7,
        7 to R.string.question_10_answer_8,
        8 to R.string.question_10_answer_9,
        9 to R.string.question_10_answer_10,
        10 to R.string.question_10_answer_11,
        11 to R.string.question_10_answer_12,
        12 to R.string.question_10_answer_13,
        13 to R.string.question_10_answer_14,
        14 to R.string.question_10_answer_15,
        15 to R.string.question_10_answer_16,
        16 to R.string.question_10_answer_17,
        17 to R.string.question_10_answer_18,
        18 to R.string.question_11_answer_1,
        19 to R.string.question_11_answer_2,
        20 to R.string.question_11_answer_3,
        21 to R.string.question_11_answer_4,
        22 to R.string.question_11_answer_5,
        23 to R.string.question_11_answer_6,
        24 to R.string.question_11_answer_7,
        25 to R.string.question_11_answer_8,
        26 to R.string.question_11_answer_9,
        27 to R.string.question_11_answer_10,
        28 to R.string.question_11_answer_11,
        29 to R.string.question_11_answer_12,
        30 to R.string.question_11_answer_13
    )
