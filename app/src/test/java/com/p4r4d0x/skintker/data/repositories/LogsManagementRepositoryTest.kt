...
import com.p4r4d0x.skintker.data.datasources.room.*
...
class LogsManagementRepositoryTest : KoinBaseTest(testRepositoriesModule, testDatasourcesModule) {
    ...
    private val log = DailyLogBO(date, IrritationBO(1, emptyList()), foodList = emptyList())
    ...
    @Before
    fun setUp() {
        repository = LogsManagementRepositoryImpl(database, firebaseDatabase)
    }
